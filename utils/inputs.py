...
Utilities that for getting and parsing inputs
Next year I'll probably avoid this kind of stuff since it makes my code "heavier"
My full repo is at https://github.com/nicolas-bolle/adventofcode2024/tree/main/
- Nick Bolle
"""
